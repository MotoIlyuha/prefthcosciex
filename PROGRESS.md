...
* **Теги `v0.0…v0.10`** созданы локально по таблице D‑039, но git‑прокси сессии не
  ...
  ```bash
  git fetch origin claude/lucid-noether-qn8zi6
  t() { git tag -a "$1" "$2" -m "$1"; }
  t v0.0 e8a778b; for n in 1 2 3; do t v0.$n 9197334; done; t v0.4 01c8c4f
  for n in 5 6 7 8 9 10; do t v0.$n 651e26d; done
